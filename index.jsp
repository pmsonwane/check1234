...
<header class="header">
    ...
    <div class="header-1">
        ...
        <a href="#" class="logo"> <i class="fas fa-book"></i> Pravin Book Store </a>
...
<section class="home" id="home">
    ...
    <div class="row">
        ...
        <div class="content">
            <h3>upto 75% off</h3>
            <p>If you are an Engineering student and need a books, Pravin Book Store has great deals on a wide range of books. Shop for these books from top authors and avail hugely discounted prices</p>
          <section>
    <h2>Personal Information</h2>
    <p>Name: Sarthak Sonwane </p>
    <p>Age: 45</p>
    <p>Location: Turin, Italy </p>
</section>


<img src="01.jpg" alt="Sarthak Sonwane">
